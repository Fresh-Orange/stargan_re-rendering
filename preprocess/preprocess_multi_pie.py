...
path_root = '../AI_DATA/multipie_align_test'
...
def preprocess_images(IMG_PATH):
    ...
    for i in range(2000):
        if i % 10000 == 0:
            print(i)
        img_path = '{}/{}/{}.png'.format(path_root, IMG_PATH, i)
    ...
    print("Saving images to %s ..." % path_root+IMG_PATH)
    torch.save(data, path_root+'/'+IMG_PATH+".pth")
