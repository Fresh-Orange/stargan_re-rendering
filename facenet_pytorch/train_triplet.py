...
# Model options
parser.add_argument('--dataroot', type=str, default='../AI_DATA/multi_pie_id_crop',
...
parser.add_argument('--margin', type=float, default=10, metavar='MARGIN',
...
test_loader = torch.utils.data.DataLoader(train_dir,
    batch_size=args.batch_size, shuffle=False, **kwargs)
...
def train(train_loader, model, optimizer, epoch):
    ...
    for batch_idx, (data_a, data_p, data_n,label_p,label_n) in pbar:
        ...
        loss = triplet_loss# cross_entropy_loss + triplet_loss
    ...
    torch.save({'epoch': epoch + 1, 'state_dict': model.state_dict()},
               './model/checkpoint__generated_256_{}.pth'.format(epoch))
    torch.save(model, "./model/facenet_generated_256_{}.ckpt".format(epoch))
